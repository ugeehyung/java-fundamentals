...
//import : 다른 패키지에 있는 클래스를 사용하기 위해서는 해당 클래스를 import해야한다.
...
public class B01_Scanner {
		...
		//콘솔로부터 입력을 받을 때에는 System.in을 이용한다.
	...
	public static void main(String[] args) {
		...
		//새로운 스캐너를 생성한 뒤 변수sc에 생성한 스캐너를 담아놓는다.
		//새로운 스캐너를 생성할 때 어디에서 입력받을 지를 설정할 수 있다.
		...
		//nextInt()
		//통로에 존재하는 다음 값을 하나만 꺼낸 뒤 해당 타임으로 변환한다.
